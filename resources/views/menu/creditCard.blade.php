    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="creditCardModalLabel">Informações do Cartão de Crédito</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('perfil.associar', auth()->id()) }}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <g id="Front">
                        ...
                        <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">Nelson Dias</text>
                        <text transform="matrix(1 0 0 1 54.1074 389.8793)" class="st7 st5 st8">Nome Titular</text>
                        <text transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">expira em</text>
                        ...
                        <g>
                            ...
                            <text transform="matrix(1 0 0 1 479.3848 435.6762)" class="st2 st10 st11">ATRAVÉZ</text>
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                                        ...
                                        <g class="st8">codigo segurança</text>
                                        </g>
                                        <rect x="58.1" y="378.6" class="st11" width="375.5" height="13.5" />
                                        <rect x="58.1" y="405.6" class="st11" width="421.7" height="13.5" />
                                        <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">Nelson Dias</text>
                                    </g>
                </svg>
                            </div>
                        </div>
                    ...
                    <div class="form-container">
                        ...
                        <div class="field-container">
                            <label for="securitycode">Codigo Segurança</label>
...
<style>
    ...
    #creditCardModal .payment-title {
        width: 100%;
        text-align: center;
    }

    #creditCardModal .form-container .field-container:first-of-type {
        grid-area: name;
    }

    #creditCardModal .form-container .field-container:nth-of-type(2) {
        grid-area: number;
    }

    #creditCardModal .form-container .field-container:nth-of-type(3) {
        grid-area: expiration;
    }

    #creditCardModal .form-container .field-container:nth-of-type(4) {
        grid-area: security;
    }

    #creditCardModal .field-container input {
        -webkit-box-sizing: border-box;
        box-sizing: border-box;
    }

    #creditCardModal .field-container {
        position: relative;
    }

    #creditCardModal .form-container {
        display: grid;
